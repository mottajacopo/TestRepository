...
namespace es_09
{
    public class Library
    {
        ...
        public void AddLibraryBook(String theTitle, String thePublisher, int theCopyrightYear, int theLoanPeriod, String theCallNumber, String theAuthor)
        {
            items.Add(new LibraryBook(theTitle, thePublisher, theCopyrightYear,
        ...
        public override string ToString()
        {
            ...
            report.Append(String.Format("Number of items stored: {0,4:d}{1}",
                GetItemCount(), System.Environment.NewLine));
            report.Append(String.Format("Number of items checked out: {0,4:d}{1}",
                GetCheckedOutCount(), System.Environment.NewLine));
            report.Append(String.Format("Number of patrons stored: {0,4:d}",
                GetPatronCount()));
